...
from ..strategy.FedOptAndroid import FedOptAndroid
from ..Utils.weights_converter import WeightsConverter

class FedYogiAndroid(FedOptAndroid):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            eval_fn (Callable[[Weights], Optional[Tuple[float, float]]],
                     optional):
            ...
            initial_parameters (Parameters): Initial set of parameters from
                                            the server.
            eta (float, optional): Server-side learning rate. Defaults to 1e-1.
            eta_l (float, optional): Client-side learning rate.
                                     Defaults to 1e-1.
            beta_1 (float, optional): Momentum parameter. Defaults to 0.9.
            beta_2 (float, optional): Second moment parameter.
                                      Defaults to 0.99.
            tau (float, optional): Controls the algorithm's
    ...
    def aggregate_fit(
        ...
        fedavg_weights_aggregate = WeightsConverter.parameters_to_weights(fedavg_parameters_aggregated)
        ...
        return WeightsConverter.weights_to_parameters(self.current_weights), metrics_aggregated
